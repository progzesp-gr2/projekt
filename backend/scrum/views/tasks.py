from rest_framework import generics # Importujemy zbiór gotowych, generycznych widoków ułatwiających operacje CRUD w DRF.
from rest_framework.permissions import IsAuthenticated # Importujemy klasę uprawnień, która sprawdza, czy użytkownik podał ważny token JWT.
from scrum.models import Task # Importujemy model Task, aby móc pobierać zadania z bazy danych.
from scrum.serializers.tasks import TaskSerializer # Importujemy utworzony przed chwilą serializator z naszego nowego pliku tasks.py.
